...
<section>
    <?php
        $friend_id = $_GET["id"];
    ?>
   	<div id="photo_box" style="margin-bottom : 10px; padding : 5px; border:5px solid #C0C0E0; border-radius: 40px 40px 40px 40px; text-align: center;">
	    <h3>
	       Photos of <?=$friend_id?>
		</h3>
	    <ul id="photo_list">
...
<?php
	...
	$sql = "select * from photos where id='$friend_id'";
